    ...
    <template #body>
      ...
      <div class="row-input items-center justify-center">
        <inputField
          ...
          label="Nombre"
          :required="true"
          @update:modelValue="(newVal: string) => (specification.name.en = newVal)"
        ...
        <inputField
          ...
          label="Nombre"
          :required="true"
          @update:modelValue="(newVal: string) => (specification.name.es = newVal)"
    ...
    <template #buttons>
      <div class="container-buttons">
        <btnPrimary
          ...
          width
          label="Guardar"
          @onClickBtn="handleAddSpecification"
          :loading="loading"
        />
        <btnPrimary
          to="/specification"
...
async function handleAddSpecification() {
  ...
  if (!invalidForm.value) {
    loading.value = true;
    const res = await createSpecification(specification.value);
    isAdd.value = true;
