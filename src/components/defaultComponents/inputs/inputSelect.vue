<template>
  <div class="">
    <div class="row q-my-sm">
      <div
        class="q-px-xs text-ap-primary nunito_bold"
        style="font-size: 14px; line-height: 19.1px"
      >
        {{ label }}
      </div>
    ...
    <q-select
      ...
      input-debounce="0"
      @filter="filterFn"
      :option-value="optionsValueLabel ? 'name' : 'id'"
      color="secondary"
      :disable="disable"
      :bg-color="disable ? 'grey-5' : 'white'"
      :required="required"
      dense
      :label="!valueInput ? placeholder : undefined"
